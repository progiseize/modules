...
class modProgiseize extends DolibarrModules
{
    ...
    public function __construct($db)
    {
        ...
        $this->numero = 300300;     // TODO Go on page http://wiki.dolibarr.org/index.php/List_of_modules_id to reserve id number for your module
        ...
        //                        );
        $this->module_parts = array(
            'css' => array('progiseize/css/progiseize.css'),
        );
        ...
        */
        ...
        $this->rights[$r][1] = 'Configurer';    // Permission label
        $this->rights[$r][3] = 1;                    // Permission by default for new user (0/1)
        $this->rights[$r][4] = 'configurer';             // In php code, permission will be checked by test if ($user->rights->permkey->level1->level2)
        ...
        // Example:
        /*$this->rights[$r][0] = $this->numero + $r;   // Permission id (must not be already used)
        $this->rights[$r][1] = 'Saisir une facture';    // Permission label
        $this->rights[$r][3] = 1;                    // Permission by default for new user (0/1)
        $this->rights[$r][4] = 'saisir';             // In php code, permission will be checked by test if ($user->rights->permkey->level1->level2)
        //$this->rights[$r][5] = 'level2';             // In php code, permission will be checked by test if ($user->rights->permkey->level1->level2)
        $r++;*/
